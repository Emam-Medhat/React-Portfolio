    ...
    <div className="relative mx-auto w-full max-w-2xl px-4 py-16">
      ...
      >
        ...
        <div className="mb-8 flex items-center gap-2">
          ...
          <span className="ml-4 text-xs font-semibold text-[#5c6370]">PropertyController.php</span>
        </div>

        {/* Code Content */}
        <pre className="text-sm leading-relaxed md:text-base font-mono">
          <code>
        ...
        {/* Floating Badges */}
        <motion.div
          className="absolute -right-6 -top-6 lg:-right-10 lg:-top-6 rounded-xl border border-white/10 bg-[#161b22]/90 px-5 py-4 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.5)] z-20"
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-[#8b949e]">Query time</span>
            </div>
            <div className="text-xl font-bold text-[#b392f0]">3ms</div>
          </motion.div>
        </motion.div>

        <motion.div
          className="absolute -left-6 bottom-32 lg:-left-12 lg:bottom-40 rounded-xl border border-white/10 bg-[#161b22]/90 px-5 py-4 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.5)] z-20"
          initial={{ y: 20, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-[#8b949e]">Auth</span>
            </div>
            <div className="text-base font-black text-white">JWT + RBAC</div>
          </motion.div>
        </motion.div>

        <motion.div
          className="absolute -right-6 -bottom-6 lg:-right-8 lg:-bottom-6 rounded-xl border border-white/10 bg-[#161b22]/90 px-5 py-4 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.5)] z-20"
          initial={{ y: 20, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
        ...
        >
          ...
          >
            ...
            <div className="text-lg font-bold text-[#b392f0]">80%+</div>
          </motion.div>
        </motion.div>
      </motion.div>
    </div>
